                ...
                <div class="w-full max-w-md">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-2">
                            ${Object.keys(this.app.config.categories).map(category => `
                                <button class="category-btn gradient-border p-2 text-white font-semibold capitalize
                                        transition-all duration-200"
                                        data-category="${category}">
                                    <div class="flex flex-col items-center">
                                        <span class="text-base">${this.getCategoryIcon(category)}</span>
                        ...
                        <div class="gradient-border p-3">
                            ...
                            <div class="grid grid-cols-3 gap-2" id="difficultyButtons">
                                ${Object.keys(this.app.config.difficulties).map(diff => `
                                    <button class="difficulty-btn ${this.app.config.settings.difficulty === diff ? 
                                        'bg-gradient-to-r from-blue-500 to-purple-500' : 'bg-gray-800 hover:bg-gray-700'} 
